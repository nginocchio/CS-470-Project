function getROIpatchesSingleDisease( diseaseLabelArray, patchWidth, patchHeight, shiftVal )
...
parentDir = strcat('.\ILD_DB_patientROIpatches\', diseasename);

% creates the folder that patches will be saved to if it doesn't exist
if exist (parentDir, 'file') ~= 7
    mkdir parentDir
end
